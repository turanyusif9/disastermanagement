...
CREATE TABLE `victim` (
  ...
  `District_DistrictID` int DEFAULT NULL,
  PRIMARY KEY (`RequesterID`),
  KEY `fk_Victim_District1_idx` (`District_DistrictID`),
  CONSTRAINT `fk_Victim_District1` FOREIGN KEY (`District_DistrictID`) REFERENCES `district` (`DistrictID`)
